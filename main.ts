...
namespace mebit_显示类 {
    ...
    //% blockId=mebit_LED1 block="LED灯|引脚 %pin|状态 %value"
    //% weight=5
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=mebit_LED2 block="LED灯|引脚 %pin|亮度 %value"
    //% weight=4
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=mebit_BreathLED block="呼吸灯|引脚 %pin"
    //% weight=3
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=mebit_RGB block="RGB七彩灯|引脚R %pin1|引脚G %pin2|引脚B %pin3|红色 %value1|绿色 %value2|蓝色 %value3"
    //% weight=2
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=mebit_RGB2 block="RGB七彩灯|引脚R %pin1|引脚G %pin2|引脚B %pin3|显示 %value"
    //% weight=1
    //% blockGap=8
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
...
namespace mebit_传感器类 {
    ...
    //% blockId=mebit_Voice_Sensor block="声音传感器|引脚 %pin|返回 %value"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_IR_Sensor block="红外传感器|引脚 %pin|  |%value|障碍物"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_IR_Send block="红外发射|引脚 %pin"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_ultrasonic block="超声波|发射管脚 %Trig|接收管脚 %Echo"
    //% color="#87CEEB"
    //% weight=100
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
...
namespace mebit_输入类 {
    ...
    //% blockId=mebit_TouchPad block="触摸开关|引脚 %pin|返回 %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    ...
    //% blockId=mebit_Rocker block="遥杆|VRX %pin1|VRY %pin2|SW %pin3|返回 %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    ...
    //% blockId=mebit_Button block="按键|引脚 %pin|返回 %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
...
namespace mebit_音乐类 {
    ...
    //% blockId=mebit_Buzzer block="有源蜂鸣器|引脚 %pin|值 %value"
    //% weight=100
    //% blockGap=10 
    //% color="#D2691E"
...
namespace mebit_电机类 {
    ...
    //% blockId=mebit_Fan block="风扇|引脚 %pin|速度 %value"
    //% weight=100
    //% blockGap=10
    //% color="#0000CD"
    ...
    //% blockId=mebit_Servo block="舵机|引脚 %pin|角度 %value"
    //% weight=100
    //% blockGap=10
    //% color="#0000CD"
...
namespace mebit_小车类 {
   ...
   function Left_F_run(speed: number) {
     ...
     * @param index
     */
    //% blockId=mebit_RGB_Car_Big2 block="小车RGB探照灯|选择车灯颜色 %value"
    //% weight=101
    //% blockGap=10
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_RGB_Car_Big block="小车RGB探照灯|红色 %value1|绿色 %value2|蓝色 %value3"
    //% weight=100
    //% blockGap=10
    //% color="#C814B8"
    //% value1.min=0 value1.max=255 value2.min=0 value2.max=255 value3.min=0 value3.max=255
    ...
    //% blockId=mebit_RGB_Car_Program block="七彩流水灯"
    //% weight=99
    //% blockGap=10
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_ultrasonic_car block="超声波返回(cm)"
    //% color="#006400"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_Music_Car block="小车音乐播放|%index"
    //% weight=97
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=mebit_Servo_Car block="小车舵机|编号 %num|角度 %value"
    //% weight=96
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=mebit_Avoid_Sensor block="避障传感器|检测到 %value"
    //% weight=95
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=mebit_Line_Sensor block="巡线传感器|位置 %direct|检测到 %value"
    //% weight=94
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=12
    ...
    //% blockId=mebit_CarCtrl block="小车控制|%index"
    //% weight=93
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=mebit_CarCtrlSpeed block="小车控制|%index|速度 %speed"
    //% weight=92
    //% blockGap=10
    ...
    //% blockId=mebit_AloneCtrlSpeed block="单独电机|%index|速度 %speed"
    //% weight=91
    //% blockGap=10
    //% speed.min=0 speed.max=255
    //% color="#006400"
